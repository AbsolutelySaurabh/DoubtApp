 ...
 * {@link MyCoinsFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link MyCoinsFragment#newInstance} factory method to
...
public class MyCoinsFragment extends Fragment {
     ...
     * @return A new instance of fragment MyCoinsFragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // getActivity().getActionBar().setTitle("My Coins");
    ...
    public void onResume(){
        super.onResume();
        ((MainActivity) getActivity()).setActionBarTitle("My Coins");
    }
