...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
       ...
       // getActivity().getActionBar().setTitle("Dashboard");
        ...
        fab_activity = (android.support.design.widget.FloatingActionButton) homeFragment.findViewById(R.id.fab_activity);
        ...
        final View f = homeFragment.findViewById(R.id.layout_fab_ask);
        fab_ask = f.findViewById(R.id.menu);

        fab_trending = (android.support.design.widget.FloatingActionButton) homeFragment.findViewById(R.id.fab_trending);
